        ...
        <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
            ...
            <form @submit.prevent="submit" class="space-y-5">
                <div>
                    ...
                    <input v-model="form.email" type="email" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 transition" :class="{ 'border-red-500 ring-1 ring-red-500': form.errors.email }">
                ...
                <div>
                    ...
                    <div class="relative mt-1">
                        <input :type="showPassword ? 'text' : 'password'" v-model="form.password" required class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 transition" :class="{ 'border-red-500 ring-1 ring-red-500': form.errors.password }">
