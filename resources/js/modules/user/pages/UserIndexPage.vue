...
const { users, loading, processingId, handleToggleStatus, handleResetPassword, handleDelete } = useUserIndex();
...
<template>
    <AuthenticatedLayout>
        ...
        <div class="sm:flex sm:items-center sm:justify-between mb-8">
            <div>
                <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Usuarios</h2>
